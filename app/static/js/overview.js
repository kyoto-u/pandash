$(function () {
  $("#finish_form").droppable({
    ...
    drop: function (event, ui) {
      ...
      function renew_finished_taskCount() { //オレンジの数字を更新する
        var finished_list = document.getElementById("finished_taskslist");
        var finished_taskCount = (typeof finished_list == null) ? 0 : finished_list.childElementCount;
        var numeral_label = document.getElementById("finished_list_num");
        numeral_label.insertAdjacentHTML("afterbegin", String(finished_taskCount));
      }
      renew_finished_taskCount();
    }
  });
  $(".taskcard").draggable({
    helper: "clone",
