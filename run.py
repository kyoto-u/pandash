...
def controller_for_students(studentid):
    ...
    sr_data.append({"resourceurl":'url1', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url2', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url3', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url4', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url5', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url6', "studentid":studentid, "status":0})
    sr_data.append({"resourceurl":'url7', "studentid":studentid, "status":0})
